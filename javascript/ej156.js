    ...
    juego3: {
     ...
     imprimirEnPantalla: function(){
        var propiedades=['nombre','precio','cantidadVendida','localidad'];
         for(var i= 1 ; i<14 ; i++){
                 console.log('');
                 var juego_array=this;
                 propiedades.forEach(function(propiedad) {
                     if(propiedad==='precio'){
                         console.log('precio: $',juego_array['juego'+i][propiedad]);
                     }else if(propiedad==='cantidadVendida'){
                        console.log('cantidad vendida',juego_array['juego'+i][propiedad],' vendidos');

                     }else{
                         console.log(propiedad,' ',juego_array['juego'+i][propiedad]);        
                     }
                 });
         }
