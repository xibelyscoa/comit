var juegos= {
    ...
    imprimirEnPantalla: function(zona){
        ...
        for(var i= 1 ; i<14 ; i++){
            ...
            if ((ella['juego'+i]['localidad'])===localidadFiltrada){
                console.log('');
...
juegos.imprimirEnPantalla(1);
console.log('');
juegos.imprimirEnPantalla(2);
console.log('');
juegos.imprimirEnPantalla(3);
console.log('');
juegos.imprimirEnPantalla(4);
